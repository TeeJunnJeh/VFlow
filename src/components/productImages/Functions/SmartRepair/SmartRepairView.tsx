  ...
  fashion_model: [
    {
      ...
      descEn: 'Turn mannequin clothing photos into realistic model wearing shots.',
      promptZh: '将服装从假人台自然迁移到真实模特身上，保留版型、面料质感和主色，保持商业拍摄质感。',
      promptEn: 'Move the clothing naturally from mannequin to a real model, preserving shape, fabric texture, and key color with commercial-grade quality.',
    },
    {
      code: 'anime_ip',
      titleZh: '卡通插画',
      titleEn: 'Anime IP',
      descZh: '生成二次元角色视觉风格。',
      descEn: 'Generate anime-style IP character visuals.',
      promptZh: '将人物与服装转换为二次元插画风格，保持服装结构与识别特征，线条清晰、色彩统一。',
      promptEn: 'Transform person and clothing into anime illustration style while preserving garment structure and key identity cues.',
    },
    {
      ...
      descZh: '生成3D渲染感服装展示图。',
      descEn: 'Create 3D-render-like garment showcase images.',
      promptZh: '将服装展示升级为3D渲染质感，突出褶皱体积、材质反射和轮廓层次。',
      promptEn: 'Upgrade the garment display into 3D-render quality with clear folds, material reflections, and dimensional silhouette.',
    },
    {
      ...
      descZh: '自动搭配配饰生成平铺图。',
      descEn: 'Auto-generate styled flat lays with accessories.',
      promptZh: '输出服装平铺图并自动补充匹配配饰，保持品牌调性和画面整洁。',
      promptEn: 'Generate a clean fashion flat lay and auto-add matching accessories consistent with brand style.',
    },
    {
      code: 'body_reshape',
      titleZh: '改身材',
      titleEn: 'Body Reshape',
      descZh: '调整模特体型比例并保持自然。',
      descEn: 'Adjust model body proportions while keeping realism.',
      promptZh: '自然调整模特体型比例，保持肢体结构合理，不改变服装细节与贴合关系。',
      promptEn: 'Adjust model body proportions naturally while keeping anatomy plausible and garment fitting details intact.',
    },
    {
  ...
  product_object: [
    {
      ...
      promptZh: '修复产品表面的划痕和凹陷，恢复完整质感，保持品牌标识和关键结构不变。',
      promptEn: 'Repair scratches and dents on product surface, restoring premium texture while preserving logo and structure.',
    },
    {
      ...
      promptZh: '保留商品主体，替换为更干净的电商背景，并保持边缘干净自然。',
      promptEn: 'Keep the product untouched and replace the background with a cleaner e-commerce scene and natural edges.',
    },
    {
      code: 'stain_remove',
      titleZh: '去污去杂',
      ...
      promptZh: '清理污点和杂物，保留原本纹理与反光，不改变产品形状。',
      promptEn: 'Clean stains and clutter while preserving original texture, highlights, and product shape.',
    },
    {
      code: 'detail_enhance',
      titleZh: '细节增强',
      ...
      descZh: '提升清晰度与微观细节表现。',
      descEn: 'Enhance sharpness and micro details.',
      promptZh: '增强细节清晰度与材质表现，控制不过锐和噪点，输出高质感电商图。',
      promptEn: 'Enhance details and material clarity while avoiding over-sharpening artifacts, producing premium commerce visuals.',
    },
  ],
  other: [
    {
      ...
      promptZh: '修复老旧图片的褪色、模糊和折痕，提升清晰度并保持原始内容真实性。',
      promptEn: 'Restore fading, blur, and creases in old images while keeping the original content authentic.',
    },
    {
      code: 'logo_cleanup',
      titleZh: 'Logo清理',
      ...
      promptZh: '清理冲突Logo与杂乱文字，保持画面构图和光影连续。',
      promptEn: 'Clean conflicting logos and messy text while preserving composition and lighting continuity.',
    },
    {
      code: 'text_replace',
      titleZh: '文案替换',
      ...
      promptZh: '替换图片中的文案内容，保持字体风格、排版节奏和整体设计语言。',
      promptEn: 'Replace text in the image while keeping typography style, layout rhythm, and design language.',
    },
    {
      code: 'custom_retouch',
      titleZh: '通用修图',
      ...
      promptZh: '根据我给出的修图要求完成目标，并保持主体一致与画质自然。',
      promptEn: 'Complete the retouch task according to my requirements while preserving subject consistency and natural image quality.',
    },
  ],
};
