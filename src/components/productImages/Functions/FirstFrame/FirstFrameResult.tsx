      ...
      {showFullImage && selectedImage && isResultSucceeded(selectedImage) ? (
        <ImageInpaintDialog
          ...
          labels={{
            ...
            done: t.pg_main_inpaint_done || '生成完毕！',
            selectVersionHint: t.pg_main_inpaint_select_version_hint || '点击左侧图片选择要保留的版本，然后继续修改或直接应用。',
            currentVersion: t.pg_main_inpaint_current_version || '当前版本',
            aiEditedVersion: t.pg_main_inpaint_ai_edited_version || 'AI 重绘版本',
            originalVersion: t.pg_main_inpaint_original_version || '原图版本',
            oneResult: t.pg_main_inpaint_one_result || '已生成 1 个修改结果',
            keepUnmodified: t.pg_main_inpaint_keep_unmodified || '保留未修改版本',
            tip: t.pg_main_tip || '提示',
            tipContinue: t.pg_main_inpaint_tip_continue || '点击“继续修改”将基于当前选中的版本进入下一轮修改。',
