    ...
    const map: Record<HelpTopPageKey, HelpSection[]> = {
      guide: [
        ...
        },
        {
          ...
          navLabel: '视频生成',
          markdown: [
            '视频生成用于将商品信息与素材快速组合为可发布的短视频成片。本平台集成了当前最新的视频生成模型，支持自定义模板与参数调整。可用模型包括[可灵](https://kling.ai/)、[Seedance](https://seed.bytedance.com/)等。',
            '',
            '### 推荐流程',
            '',
            '1. 进入[工作台](/app)，按需选择视频生成的模型（目前支持 Seedance 2.5、可灵 o1，Sora 已下线）',
            '',
      ...
      pricing: [
        ...
        },
        {
          ...
          markdown: [
            ...
            '| --- | --- | --- | --- | --- |',
            '| 视频生成-极速出片 | Seedance 2.5 | 480p / 720p | 460 V / 百万 tokens | 280 V / 百万 tokens |',
            '',
